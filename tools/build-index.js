...
.jump{display:flex;flex-wrap:wrap;gap:8px 18px;font-size:13.5px;margin:0 0 44px;padding-bottom:18px;border-bottom:1px solid var(--hair)}
.jump a{color:var(--muted);text-decoration:none;border-bottom:1px solid transparent}
...
li a{display:flex;align-items:baseline;gap:12px;flex-wrap:wrap;padding:16px 2px;color:var(--ink);text-decoration:none}
