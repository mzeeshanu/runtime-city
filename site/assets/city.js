    ...
    districts: [
      {
        ...
        playrooms: [
          ...
          {slug:'factory-method', icon:'factory', short:'Factory',       title:'Factory Method',       blurb:'grow a switch until it breaks, then cut a hole'},
          {slug:'strategy', icon:'options', short:'Strategy',             title:'Strategy',             blurb:'drown a method in flags, then hand the algorithm in'},
      ...
      },
      {
        ...
        playrooms: [
          ...
          {slug:'caching', icon:'cache', short:'Cache',            title:'Caching',            blurb:'fast answers, stale answers, and the stampede'}
        ],
        soon: []
      },
      {
        ...
        open: true,
        playrooms: [
          {slug:'single-responsibility', icon:'onejob', short:'SRP',  title:'Single Responsibility',  blurb:'four departments, one file, and the crack down the middle'},
          {slug:'open-closed', icon:'openext', short:'OCP',            title:'Open/Closed',            blurb:'stop editing the engine to add a promotion'},
          {slug:'liskov-substitution', icon:'swap', short:'LSP',    title:'Liskov Substitution',    blurb:'a square that makes a correct test fail'},
          {slug:'interface-segregation', icon:'segment', short:'ISP',  title:'Interface Segregation',  blurb:'a printer forced to promise it can fax'},
          {slug:'dependency-inversion', icon:'invert', short:'DIP',   title:'Dependency Inversion',   blurb:'flip the arrow between your rules and your database'}
        ],
        soon: []
      },
      {
        ...
        playrooms: [
          ...
          {slug:'tcp', icon:'syn', short:'TCP',  title:'TCP',  blurb:'pay for a handshake, then lose one packet'},
          {slug:'http', icon:'envelope', short:'HTTP', title:'HTTP', blurb:'verbs that promise things and codes that mean things'},
          {slug:'tls', icon:'shield', short:'TLS',  title:'TLS',  blurb:'your password on the wire, then the padlock'}
        ],
        soon: []
      },
      {
        ...
        open: true,
        playrooms: [
          {slug:'indexes', icon:'index', short:'Indexes',          title:'Indexes',          blurb:'read a million rows, then read four'},
          {slug:'joins', icon:'venn', short:'Joins',            title:'Joins',            blurb:'which rows survive, and the accidental 101 queries'},
          {slug:'transactions', icon:'commit', short:'Tx',     title:'Transactions',     blurb:'crash halfway and lose £100, then do not'},
          {slug:'isolation-levels', icon:'isolate', short:'Isolation', title:'Isolation Levels', blurb:'two sessions, four anomalies, one lost sale'}
        ],
        soon: []
      },
      {
        ...
        playrooms: [
          ...
          {slug:'deadlocks', icon:'cycle', short:'Deadlock',   title:'Deadlocks',     blurb:'both waiting, both polite, forever'},
